...
import { X, Check, Shield, FileText, AlertTriangle, MessageCircle, Users } from 'lucide-react';
...
export default function ContactPaymentModal({ isOpen, onClose }: ContactPaymentModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-gray-900 rounded-2xl border border-white/10 shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-primary p-6 text-center relative">
          ...
          <h2 className="text-2xl font-bold text-black mb-2">联系支付</h2>
          <p className="text-black/70 text-sm">扫码添加客服，完成账号交易</p>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-white/5 rounded-xl p-4 border border-white/10">
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex items-start gap-2">
                ...
                <span>扫码添加客服为好友，说明您要出售的账号信息</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary mt-1">•</span>
                <span>客服将为您提供详细的交易流程指导</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary mt-1">•</span>
                <span>完成审核后，款项将立即打入您的账户</span>
              </li>
            </ul>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            />
            <Label htmlFor="agreement" className="text-sm text-gray-400 cursor-pointer leading-relaxed">
              我已阅读并同意
              <a href="#" className="text-primary hover:underline mx-1">《账号出售服务协议》</a>
              和
